...
import { ContentConfigSchema } from './content-config.schema';

const validateConfig = (config: Record<string, unknown>) => {
  const validatedConfig = plainToInstance(ContentConfigSchema, config, {
...
export const contentConfig = registerAs('content', () => {
