            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="flex flex-col gap-1.5">
                  <div className="text-stone-50 text-sm font-medium font-['Inter']">Lead ID</div>
                  <div className="text-stone-300 text-sm font-normal font-['Inter']">#${lead?.id.split('-')[0]}</div>
                </div>
                <div className="flex flex-col gap-1.5">
                  <div className="text-stone-50 text-sm font-medium font-['Inter']">Coach</div>
                  <div className="text-stone-300 text-sm font-normal font-['Inter']">{lead?.coach ? `${lead.coach.firstName} ${lead.coach.lastName}` : 'N/A'}</div>
                </div>
                <div className="flex flex-col gap-1.5">
                  <div className="text-stone-50 text-sm font-medium font-['Inter']">Added</div>
                  <div className="text-stone-300 text-sm font-normal font-['Inter']">{lead?.createdAt && formatDate(lead.createdAt)}</div>
                </div>
                <div className="flex flex-col gap-1.5">
                  <div className="text-stone-50 text-sm font-medium font-['Inter']">Last Contacted</div>
                  <div className="text-stone-300 text-sm font-normal font-['Inter']">
        ...
        <div className="hidden lg:block h-[792px]">
          <div className="absolute left-[30px] top-[30px] w-80 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-x-3 gap-y-4 mt-[47px]">
              ...
              <div className="flex flex-col gap-1.5">
                <div className="text-stone-50 text-sm font-medium font-['Inter']">Date Added</div>
                <div className="text-stone-300 text-sm font-normal font-['Inter']">
