...
import { ImageCropper } from '@nlc-ai/web-shared';
          ...
          <div className="p-4 md:p-8">
            ...
            <div className="flex flex-col lg:flex-row justify-center items-start gap-[30px] w-full relative">
              <div className="flex flex-col items-start gap-3 w-full lg:w-auto">
                ...
                {coverImage ? (
                  <div className="relative group w-full lg:w-[441px] rounded-[10px] overflow-hidden border border-white/20">
                    <img
                      src={coverImage.url}
                      alt={coverImage.name}
                  ...
                  >
                    <div className="flex flex-col items-center gap-5">
                      ...
                      <span className="text-white font-inter text-lg md:text-xl font-normal leading-5">
                        ...
                        Recommended: 1280x720px (16:9 ratio) • Max 10MB
                      </span>
                      </div>
                    </div>
                  </button>
