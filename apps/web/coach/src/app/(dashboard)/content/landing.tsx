...
import {BarChart3, Calendar, CheckCircle, Clock, Target, TrendingUp, TvMinimalPlay, Zap} from "lucide-react";

export const ContentManagementLanding = () => {
  ...
  return (
    <div className="px-4 py-4 sm:py-6 lg:py-8 space-y-8 max-w-full overflow-hidden">
      {/* Hero Section */}
