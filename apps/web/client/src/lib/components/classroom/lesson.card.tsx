...
export const LessonCard: FC<IProps> = ({ image, title, description, locked = false }) => {
  return (
    <div className="glass-card rounded-4xl flex-1 relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="p-7.5 space-y-7">
          <div className="space-y-3">
            <h3 className={`text-xl font-semibold leading-normal ${locked ? 'line-through' : ''} text-foreground`}>
              {title}
            </h3>
            <p className="text-base text-foreground/40 leading-[22px]">
              {description}
            </p>
          </div>
          ...
          {locked && (
            <div className="space-y-2.5">
              <div className="flex justify-between items-center">
                <span className="text-sm font-semibold text-foreground/40">Lessons</span>
                <a href="#" className="text-sm text-[#FF7915] underline">Pay to unlock</a>
              </div>
        ...
        {locked && (
          <div className="absolute top-5 left-5 p-3 rounded-2xl bg-background">
