...
import {CommunityDetails, HeroSection, TopNavigation} from "@/lib";
...
const CommunityLanding = () => {
  const community = {
    ...
    pricing: 5,
    logo: "https://api.builder.io/api/v1/image/assets/TEMP/35788eae9eef329552b4887ff94504c1392bcbee?width=80",
