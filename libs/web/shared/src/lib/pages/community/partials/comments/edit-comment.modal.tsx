...
export const EditCommentModal = ({
 ...
 onSaveSuccess
  ...
  const handleSave = async () => {
    ...
    setIsSaving(true);
    try {
      await sdkClient.communities.comments.updateComment(communityID, commentID, {
      ...
      <div className="relative bg-gradient-to-b from-neutral-800/30 to-neutral-900/30 rounded-[20px] lg:rounded-[30px] border border-neutral-700 p-6 lg:p-8 w-full max-w-2xl">
        ...
        <div className="relative z-10">
          ...
          <div className="space-y-6">
            <div>
              <Label htmlFor="commentContent" className="text-white text-sm mb-2 block">
                ...
                <div className="absolute bottom-2 right-2 flex items-center gap-2">
                  <span className={`text-xs ${
                    isOverLimit ? 'text-red-400' :
                      characterCount > COMMENT_MAX_LENGTH * 0.8 ? 'text-yellow-400' :
                        'text-stone-500'
                  }`}>
