...
export const appConfig: AppConfig = {
  ...
  api: {
    ...
    services: {
      ...
      content: `${process.env.NEXT_PUBLIC_API_URL}/content`,
    },
  },
  auth: {
  ...
  app: {
    name: process.env.NEXT_PUBLIC_APP_NAME || 'Next Level Coach AI',
    supportEmail: process.env.NEXT_PUBLIC_SUPPORT_EMAIL || 'support@nextlevelcoach.ai',
